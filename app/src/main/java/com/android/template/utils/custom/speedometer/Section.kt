...
//this is class for background line where defrent color
class Section @JvmOverloads constructor(startOffset: Float, endOffset: Float, color: Int, width: Float = 0f):
    Parcelable {
    ...
    constructor(section: Section) : this(section.startOffset, section.endOffset, section.color, section.width) {
        padding = section.padding
    }

    constructor(parcel: Parcel) : this(parcel.readFloat(), parcel.readFloat(), parcel.readInt(), parcel.readFloat()) {
     ...
     */
    private fun setStartEndOffset(startOffset: Float, endOffset: Float) {
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        ...
        parcel.writeSerializable(Style.BUTT)
